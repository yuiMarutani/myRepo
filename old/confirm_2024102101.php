                    ...
                    <div class="container" style="padding:20px;">
                        ...
                        <div class="row my-4">
                            <div class="col-12 col-md-6 col-lg-3 mb-4 mb-lg-0" style="display:flex;justify-content:center;">
                                <div class="card" style="min-width:20rem;height:30rem;">
                                    ...
                                    <div class="card-body">
                                        <p class="card-text" style="">
                                            ...
                                            <table class="table table-sm">
                                                ...
                                                <tr>
                                                    <td style="text-align:right;"><button type="button" class="btn btn-success" onclick="location.href='edit.php'">編集</button></td>
                                                    <td><button type="button" class="btn btn-dark" onclick="location.href='delete.php'">削除</button></td>
                                                </tr>
                                                <tr>
