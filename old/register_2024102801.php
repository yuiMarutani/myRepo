...
session_start();
print_r($_SESSION);
//register_confirm.phpからのデータを受け取り成形
$form_data_2 = isset($_SESSION['form_data_2']) ? $_SESSION['form_data_2'] : [];
unset($_SESSION['form_data_2']);
...
if($_SERVER['REQUEST_METHOD']==='POST'){
    ...
    //sessionの作成（register.phpへ飛ばす）
    $_SESSION['form_data'] = array($user_name,$USERS_ID,$email,$password);
    
    //エラーメッセージが空ならregister_confirm.phpへリダイレクト
    if(empty($err_msg)){
