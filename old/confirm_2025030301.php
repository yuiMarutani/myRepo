                                ...
                                <div  class="py-3 col-4">
                                    <!--form開始-->
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="10" name="memopad"></textarea>
                                        </div>
                                        <div style="justify-content:center;display:flex;">
                                            <button type="submit" class="btn btn-warning" onclick="location.href='registerConfirm.php'">確認</button>
                                        </div>
                                    </div>
                                    <script>
                                        //合計金額の算出
