                    ...
                    <div class="col" style="display:flex;justify-content:center;">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="mb-3">
                                            <input type="text" name="USERS_ID" class="form-control" id="exampleFormControlInput1" placeholder="">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="mb-3">
                                            <input type="text" name="password" class="form-control" id="exampleFormControlInput3" placeholder="">
                                        </div>
                                    </td>
                                </tr>
                            </table>
                ...
                <div class="container text-center;">
                    <div class="row">
                        ...
                        <div class="col" style="text-align:center;">
                            <button type="submit" name="action" class="btn btn-secondary" value="add" onclick="location.href='login.php'">戻る</button>
                            <button type="submit" name="action" class="btn btn-primary" value="add" onclick="location.href='register_confirm.php'">確認</button>
                        </div>
                        <div class="col">
