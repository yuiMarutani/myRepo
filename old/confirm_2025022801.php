                                                            ...
                                                            <table class="table table-sm">
                                                                ...
                                                                <tr>
                                                                    <td colspan="2" style="text-align:center;">
                                                                        <input type="checkbox" name="check" class="btn-check" id="btn-check-1-outlined<?=$v['order_id']?>" checked autocomplete="off" value="<?=$v['total'] ?>" onclick="calculateTotal()">
                       ...
                       <div  class="py-3" style="display:flex;justify-content:center;">
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <div style="display:flex;">
                                            <td style="font-size:25px;"><span id="total" style="font-size:25px;"></span>円</td>
                                        </div>
                            ...
                            function calculateTotal() {
                                ...
                                if (goal - total >= 0) {
                                    ...
                                    document.getElementById('error_4').innerText = "所持金残り" + money + "円です";
                                } else {
