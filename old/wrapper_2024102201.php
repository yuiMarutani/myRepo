            ...
            <div class="row flex-no-wrap">
                ...
                <div class="col py-3">
                    ...
                    <p class="lead">
                        ...
                        また、家計簿のように商品の購入履歴を追跡することができます。
                    </p>
                    <ul class="list-unstyled">
                        <li><h5 style="color:pink;">ご使用方法</h5>1.「設定」より登録金額や消費税額、目標金額の設定をします。</li>
                        <li>2.「候補登録」にて購入検討中の商品の情報を登録します。商品登録後、一覧画面下に追加された商品の情報が出ます。こちらで購入前の商品情報の編集削除ができます。</li>
                        <li>3.「購入確定」で購入したい商品を確認します。全選択されており、解除したい商品のみ選択解除します。右下の残高等の情報を確認しよければ確認ボタンを押します。</li>
                        <li>4.「購入確定」の購入確認ボタン押下後「確定ボタン」を押し商品の購入を確定します。</li>
                        <li>5.「購入履歴」からお買い物履歴を確認できます。セレクトボックスで年と日付を絞り込むと便利です。</li>
                    </ul>
                </div>
            </div>
        </div>
